...
INSERT INTO "new_Issue" ("addressLine1", "addressLine2", "area", "caseId", "categoryId", "citizenId", "city", "county", "createdAt", "description", "id", "latitude", "longitude", "staffId", "status", "suburb", "title", "updatedAt") SELECT "addressLine1", "addressLine2", "area", "caseId", "categoryId", "citizenId", "city", "county", "createdAt", "description", "id", "latitude", "longitude", "staffId", "status", "suburb", "title", "updatedAt" FROM "Issue";
DROP TABLE "Issue";
