/*
  ...
  - You are about to drop the column `town` on the `Issue` table. All the data in the column will be lost.
...
INSERT INTO "new_Issue" ("addressLine1", "addressLine2", "caseId", "categoryId", "citizenId", "city", "county", "createdAt", "description", "id", "latitude", "longitude", "staffId", "status", "title", "updatedAt") SELECT "addressLine1", "addressLine2", "caseId", "categoryId", "citizenId", "city", "county", "createdAt", "description", "id", "latitude", "longitude", "staffId", "status", "title", "updatedAt" FROM "Issue";
DROP TABLE "Issue";
