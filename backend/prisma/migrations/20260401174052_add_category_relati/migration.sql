...
INSERT INTO "new_Issue" ("addressLine1", "addressLine2", "caseId", "citizenId", "city", "county", "createdAt", "description", "eircode", "id", "staffId", "status", "title", "town", "updatedAt") SELECT "addressLine1", "addressLine2", "caseId", "citizenId", "city", "county", "createdAt", "description", "eircode", "id", "staffId", "status", "title", "town", "updatedAt" FROM "Issue";
DROP TABLE "Issue";
